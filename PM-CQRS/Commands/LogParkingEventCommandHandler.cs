...
{
    public class LogParkingEventCommandHandler : ICommandHandler<LogParkingEventCommand>
    {
        private readonly IDbContext<IUnitOfWork> _uow;

        public LogParkingEventCommandHandler(IDbContext<IUnitOfWork> uow)
        {
        ...
        public async Task<OperationResult> HandleAsync(LogParkingEventCommand command, CancellationToken cancellationToken = default)
        {
