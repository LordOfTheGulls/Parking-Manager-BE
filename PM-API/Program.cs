...
builder.Services.AddScoped<IQueryHandler<GetParkingPricingIntervals, Dictionary<short, IEnumerable<ParkingPricingDto>>>, GetParkingPricingIntervalsQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetParkingWorkhours, List<WorkhoursDTO>>, GetParkingWorkhoursQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetParkingBlacklist, List<ParkingBlacklistDto>>, GetParkingBlacklistQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetUserQuery, UserDTO>, GetUserQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetUsersQuery, PagingResult<UserDTO>>, GetUsersQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetUserPermissionsQuery, UserRightDto>, GetUserPermissionsQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetParkingLotInfoQuery, ParkingLotDto>, GetParkingLotInfoQueryHandler>();
builder.Services.AddScoped<IQueryHandler<GetAllPaymentsQuery, PagingResult<ParkingLotPaymentDto>>, GetAllPaymentsQueryHandler>();
...
builder.Services.AddScoped<ICommandHandler<UpdateParkingPricingIntervalCommand>, UpdateParkingPricingIntervalCommandHandler>();
builder.Services.AddScoped<ICommandHandler<UpdateParkingWorkhoursCommand>, UpdateParkingWorkhoursCommandHandler>();
builder.Services.AddScoped<ICommandHandler<UpdateParkingBlacklist>, UpdateParkingBlacklistCommandHandler>();
builder.Services.AddScoped<ICommandHandler<DeleteParkingBlacklistCommand>, DeleteParkingBlacklistCommandHandler>();
builder.Services.AddScoped<ICommandHandler<AddParkingBlacklistCommand>, AddParkingBlacklistCommandHandler>();
...
builder.Services.AddScoped<ICommandHandler<AddParkingPricingIntervalCommand>, AddParkingPricingIntervalCommandHandler>();
builder.Services.AddScoped<ICommandHandler<DeleteParkingPricingIntervalCommand>, DeleteParkingPricingIntervalCommandHandler>();
